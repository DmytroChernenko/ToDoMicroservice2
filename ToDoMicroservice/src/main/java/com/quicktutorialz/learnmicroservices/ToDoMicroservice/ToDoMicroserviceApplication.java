...
import com.quicktutorialz.learnmicroservices.ToDoMicroservice.dao.ToDoDao;
import com.quicktutorialz.learnmicroservices.ToDoMicroservice.dao.UserDao;
...
public class ToDoMicroserviceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		userDao.save(new com.quicktutorialz.learnmicroservices.ToDoMicroservice.entities.User("alex@quicktutorialz.com", "Alessandro Argentieri", encryptedPwd));

		encryptedPwd = encryptionUtils.encrypt("MyPwd");
		userDao.save(new com.quicktutorialz.learnmicroservices.ToDoMicroservice.entities.User("franz@quicktutorialz.com", "Franz Leroy", encryptedPwd));

		encryptedPwd = encryptionUtils.encrypt("Belle");
		userDao.save(new com.quicktutorialz.learnmicroservices.ToDoMicroservice.entities.User("annabelle@quicktutorialz.com", "Annabelle Sorah", encryptedPwd));
